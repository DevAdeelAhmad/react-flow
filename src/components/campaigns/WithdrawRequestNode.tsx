...
interface WithdrawRequestNodeProps extends NodeProps {
    onPlusClick: () => void;
    onSelect: (type: string) => void;
}

const WithdrawRequestNode: React.FC<WithdrawRequestNodeProps> = ({ data }) => {
    return (
...
export default WithdrawRequestNode;
